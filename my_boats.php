...
<section class="" action="./php/my_boat_ajax.php" >
    <br>
    <div class="width_my_dashboard row" >
        ...
        <div class="col-2">
            <div class="card" style="border: none">
                ...
                <br>
                <a href="add_boat.php">
                <button class="btn btn-outline-primary my-2 my-sm-0" type="submit">Aggiungi Barca</button></a>
                <br>
            </div>
        </div>
        ...
        <div class="col-10" id="content">
            ...
            <?php
                ...
                {
                    header("Location: ../my_boats.php?error=my_boat_error");
                    exit();
                }
        ...
        <script>   
            ...
            $(document).on("click", ".pagination_ajax",function( e ) {
                ...
                $.get( "./php/my_boat_ajax.php", { num_page: page }, function( html ) {
                    console.log(html);
                    $( "#content" ).html( html );
                });
            });
